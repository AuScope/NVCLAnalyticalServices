...
public class TsgMod {
    private static String libPath = "/home/LingboJiang/work/ws/NVCLAnalyticalServices/src/main/c/tsgmod/";
    static {
    ...
    public boolean parseOneScalarMethod() {
        try {
        ...
        //scrtx = new String(Files.readAllBytes(Paths.get(libPath + "0tstscript.txt")), "ASCII");
