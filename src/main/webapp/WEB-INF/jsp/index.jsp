...
<html>
  ...
  <body  class="NVCLDSBody">
  	...
  	<p>The NVCL Analytical Services provide a bundle of basic interfaces for analytical and query from National Virtual Core Library datasets.  The output of these services is intended to supply a better query and analytical tool for use in data access portals</p>
  	<p>A few Testcase provided are listed bellow.</p>
	<table class="usageTable"><tr><th>To server</th><th>Description</th><th>url</th></tr>
                   
	<tr><td>Submit to nvclwebservice</td><td>logs with the name "Min1 uTSAS" Muscovite greater than 50 percent within 1 metre span.</td><td><a href="submitNVCLAnalyticalJob.do?serviceurls=http://nvclwebservices.vm.csiro.au/geoserverBH/wfs&email=lingbo.jiang@csiro.au&jobname=test001&logname=Min1%20uTSAS&classification=Muscovite&startdepth=0&enddepth=999999&logicalop=gt&value=50&units=pct&span=1">submitNVCLAnalyticalJob.do</a></td></tr>
	<tr><td>Submit to NT</td><td>logs with the name "Min1 sTSAS" dickite greater than 10 sample count within 1 metre span.</td><td><a href="submitNVCLAnalyticalJob.do?serviceurls=http://geology.data.nt.gov.au/geoserver/wfs&email=lingbo.jiang@csiro.au&jobname=test002&logname=Min1%20sTSAS&classification=Dickite&startdepth=0&enddepth=99999&logicalop=gt&value=10&units=count&span=1">submitNVCLAnalyticalJob.do</a></td></tr>
    <tr><td>Submit to NSW</td><td>logs with the name "Min1 sTSAS" dickite greater than 5 sample count within 99999 metre span.</td><td><a href="submitNVCLAnalyticalJob.do?serviceurls=http://auscope.dpi.nsw.gov.au/geoserver/wfs&email=lingbo.jiang@csiro.au&jobname=test003&logname=Min1%20sTSAS&classification=Dickite&startdepth=0&enddepth=99999&logicalop=gt&value=5&units=count&span=99999">submitNVCLAnalyticalJob.do</a></td></tr>
